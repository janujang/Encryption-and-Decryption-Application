 ...
 * Date: October 1 2016
 * Description: This program generates random encrypted phrases given a text file with the phrases. 
 * Method List: 
 * String randomWord () throws IOException //method to generate random encrypted phrases 
 */
public class RandomEncryptedPhrases
{
	public static String randomWord () throws IOException
	{
		...
		String fileName = "Files/EncryptedPhrases.txt";
